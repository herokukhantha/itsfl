...
import { createProductReview, 
  listProductDetails } from "../Redux/Actions/ProductActions";
import Loading from "../components/LoadingError/Loading";
import { productCreateReviewReducer } from "../Redux/Reducers/ProductReducer";
...
const SingleProduct = ({ history, match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(listProductDetails(productId));
  },[dispatch, productId,succesCreateReview])
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(createProductReview(productId,{rating,
      comment,
    }))
  };
